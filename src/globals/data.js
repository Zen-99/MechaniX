export const filterData = [ {name:"Help Requests",image: require('../../assets/icon.png'), id:"0"},
                            {name:"Troubles Nearby",image:require("../../assets/adaptive-icon.png"),id:"1"},
                            // {name:"Package",image:require("../../assets/icon.png"),id:"2"},
                            // {name:"Reserve",image:require("../../assets/icon.png"),id:"3"}
...
export const paymentOptions = [{image:require('../../assets/icon.png'),text:"Visa ...0476"},
                                {image:require('../../assets/icon.png'),text:"Cash"}]
